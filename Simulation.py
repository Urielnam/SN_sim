...
array_sensor = QueueGraphics(array_sensor_queue, 25, "Array to \n Sensor", canvas,
                             200, start_row)
array_analysis = QueueGraphics(array_analysis_queue, 25, "Array to \n Analysis", canvas, 300, start_row)
analysis_sublist_visual = QueueGraphics(analysis_sublist, 25, "Analysis Station \n Bank", canvas, 600, start_row)
analysis_array = QueueGraphics(analysis_array_queue, 25, "Analysis to \n Array", canvas, 700, start_row)
array_action = QueueGraphics(array_action_queue, 25, "Array to \n Action", canvas, 800, start_row)
action_array = QueueGraphics(action_array_queue, 25, "Action to \n Array", canvas, 900, start_row)
...
def create_clock(env):
    ...
    while True:
        ...
        array_analysis.paint_queue()
        analysis_array.paint_queue()
