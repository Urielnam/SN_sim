...
def run_simulation(i, ui, print_excel, end_time, max_resource, dt):
    simulation_collector["run #" + str(i)] = Simulation.main_run(ui, print_excel, end_time, max_resource, dt)
